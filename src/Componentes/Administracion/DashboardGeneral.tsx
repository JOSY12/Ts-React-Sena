...
const DashboardGeneral = () => {
  ...
  return (
    <div className='flex  bg-gray-100'>
      ...
      <div className='  hidden  h-screen   lg:block  z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0'>
      ...
      <div className=' sm:block lg:hidden'>
        ...
        <nav className='flex  bottom-10 w-full justify-around     fixed'>
          <a className='w-full flex items-center text-center  justify-center px-6 py-2 mt-4 text-gray-100  bg-gray-900 bg-opacity-25'>
            <svg
              className='w-6 h-6'
              xmlns='http://www.w3.org/2000/svg'
              fill='none'
      ...
      {/* fin del navbar movil */}

      {/* inicio plantilla general de informacion */}
      ...
      {/* fin de plantilla general de informacion */}
    </div>
  )
}
