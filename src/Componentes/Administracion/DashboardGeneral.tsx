    ...
    <>
      <div>
        <div className='flex h-screen bg-gray-200'>
          ...
          <div className='  hidden     lg:block  z-30 w-64 overflow-y-auto transition duration-300 transform bg-gray-900 lg:translate-x-0 lg:static lg:inset-0'>
            ...
            <nav className='mt-10  '>
              <a className='flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25'>
                ...
                <span className='mx-3'>Administracion</span>
              </a>
