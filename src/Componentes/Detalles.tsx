  ...
  return (
    <div>
      <div className='2xl:container 2xl:mx-auto md:py-12 lg:px-20 md:px-6 py-9 px-4'>
        <div
          id='viewerBox'
          className='lg:p-10 md:p-6 p-4 bg-white :bg-gray-900'
        >
          ...
          <div className='mt-3 md:mt-4 lg:mt-0 flex flex-col lg:flex-row items-strech justify-center lg:space-x-8'>
            ...
            <div className='lg:w-1/2 flex flex-col justify-center mt-7 md:mt-8 lg:mt-0 pb-8 lg:pb-0'>
              <h1 className='text-3xl lg:text-4xl font-semibold text-gray-800 :text-white'>
                Computadora
              </h1>
              <p className='text-base leading-normal text-gray-600 :text-white mt-2'>
                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ea
                eaque voluptatibus fuga provident velit nulla voluptatem ut cum
                modi ipsam voluptatum voluptates doloremque repellendus, culpa
                nostrum reprehenderit iusto commodi tempore!
              </p>
              <p className='text-3xl font-medium text-gray-600 :text-white mt-8 md:mt-10'></p>
              <div className='flex items-center flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-6 lg:space-x-8 mt-8 md:mt-16'>
                <button className='w-full md:w-3/5 border border-gray-800 text-base font-medium leading-none   uppercase py-6 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 bg-gray-800 text-white :bg-white :text-gray-900 :hover:bg-gray-200'>
                  agregra a carrito
                </button>
                <button className='w-full md:w-2/5 border border-gray-800 text-base font-medium leading-none text-gray-800  uppercase py-6 bg-transparent focus:outline-none focus:ring-2 focus:ring-offset-2 :bg-transparent :border-white :text-white focus:ring-gray-800 hover:bg-gray-800 hover:text-white :hover:bg-gray-800 '>
                  Ver detalles
                </button>
              </div>
              <div className='mt-6'>
                <button className='text-xl underline text-gray-800 :text-white :hover:text-gray-200 capitalize hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800'>
                  agregar a favoritos
                </button>
              </div>
            </div>
